...
class AnNet(nn.Module):
    ...
    def __init__(self, in_channels: int):
        super().__init__()
        # ----- Encoder -----
        self.encode_1 = EncodeSample(in_channels, 32)
        self.encode_2 = EncodeSample(32, 64)
        self.encode_3 = EncodeSample(64, 128)
        self.encode_4 = EncodeSample(128, 256)
        ...
        self.decode_1 = DecodeSample(512, 256)
        self.decode_2 = DecodeSample(256, 128)
        self.decode_3 = DecodeSample(128, 64)
        self.decode_4 = DecodeSample(64, 32)
